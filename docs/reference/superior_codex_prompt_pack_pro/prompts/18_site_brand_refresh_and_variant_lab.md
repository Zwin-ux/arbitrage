# Prompt 18: Refresh the public site so it matches the desktop product’s premium arcade-machine identity
...
Upgrade the Astro site so it feels like the public face of Superior rather than a placeholder landing page. Keep it restrained, distinct, and honest.

## Files to inspect first

- `site/src/data/landingVariants.js`
- `site/src/components/landing/HeroSection.jsx`
- `site/src/components/landing/ProductPreview.jsx`
- `site/src/components/landing/ScannerVisual.jsx`
...
1. Refine the site copy so it sells the product clearly without hype or money claims.
2. Push the visual system further toward authored arcade-cabinet geometry and away from startup-site sameness.
3. Strengthen the product preview so Hangar / Bot Bay / Score / Live Gate are clearer.
4. Use the existing variant lab intentionally; do not let the control and focus variants drift into random experiments.
5. Update browser tests if the structure changes.

## Constraints

- Do not make the site look like a crypto affiliate funnel.
- Keep Windows download and GitHub actions clear.
- Preserve honest product posture.
...
- The site feels like Superior’s public front door.
- The product is easier to understand in one glance.
- The site and EXE feel like the same world.
