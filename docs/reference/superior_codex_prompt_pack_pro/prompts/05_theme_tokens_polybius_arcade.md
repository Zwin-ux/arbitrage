# Prompt 05: Upgrade theme tokens and visual rules for a Polybius-grade arcade machine aesthetic
...
Strengthen the theme system so Superior consistently expresses the repo’s documented graphics language: dark, radial, vector-based, arcade-inspired, and trustworthy.
...
1. Refine theme tokens so color, tone, surface, and type ramps are more systematic and reusable.
2. Bring the desktop and site visual language closer together without making them identical clones.
3. Strengthen semantic state color usage: active, warning, locked, idle, success, error.
4. Introduce clearer rules for borders, insets, focus rings, console panes, and machine panels.
5. Use Polybius/arcade influence as disciplined geometry, not noisy nostalgia.

## Constraints

- Do not add visual clutter or gratuitous gradients.
- Avoid over-saturating the interface.
- Do not replace the current design language with generic neon cyberpunk.
...
- Colors feel intentional and semantic.
- The app looks more cohesive and authored.
- The site and desktop clearly belong to the same world.
