# Prompt 15: Add decision traces for paper execution and bot sessions
...
Add a proper decision-trace layer so users can see what a paper bot saw, why it acted, why it skipped, and how the run affected score.
...
1. Design a concise but expressive decision trace model for paper runs and bot sessions.
2. Capture route selection, gate checks, stake choice, skip reasons, and score outcomes in a reviewable format.
3. Expose traces in the UI in a way that feels like a machine log or tactical replay, not a wall of JSON.
4. Add tests around trace generation and UI rendering.

## Constraints

- Do not drown the user in noise.
- Trace data should be human-readable first.
...
- A user can understand why a bot acted or skipped.
- The app feels dramatically more inspectable.
- This becomes a core pillar for Replay Lab and Bot Garage.
